...
#pod =head2 Hints
#pod
#pod A hint is a comment starting with I<one hash>, followed by C<REQUIRE> keyword, I<colon>, module
#pod name, and optional version range and comment, e. g.:
#pod
...
#pod required, CPAN client does not insist on installing C<IPC::System::Simple>. Thus, code may fail due
#pod to missed C<IPC::System::Simple>.
#pod
#pod A hint allows to avoid this trouble:
#pod
#pod     use autodie ':all'; # REQUIRE: IPC::System::Simple
#pod
...
#pod
#pod Be careful in writing "REQUIRE" keyword. Mistyped keywords are not recognized and silently ignored.
#pod
#pod =caveat File name
#pod
...
#pod
#pod =for :list
#pod * L<< [Feature request] filename attribute to PPI::Document->new|https://github.com/adamkennedy/PPI/issues/180 >>
...
A hint is a comment starting with I<one hash>, followed by C<REQUIRE> keyword, I<colon>, module
name, and optional version range and comment, e. g.:
...
required, CPAN client does not insist on installing C<IPC::System::Simple>. Thus, code may fail due
to missed C<IPC::System::Simple>.
